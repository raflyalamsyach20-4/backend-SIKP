...
export type SubmissionVerificationStatusType =
  (typeof SubmissionVerificationStatus)[keyof typeof SubmissionVerificationStatus];
...
export type SubmissionWorkflowStageType =
  (typeof SubmissionWorkflowStage)[keyof typeof SubmissionWorkflowStage];
...
export type DocumentReviewStatusType =
...
export type ResponseLetterStatusType =
  (typeof ResponseLetterStatus)[keyof typeof ResponseLetterStatus];
...
export type ResponseLetterTrackingStatusType =
  (typeof ResponseLetterTrackingStatus)[keyof typeof ResponseLetterTrackingStatus];
