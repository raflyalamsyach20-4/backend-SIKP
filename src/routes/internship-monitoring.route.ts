...
export const createInternshipMonitoringRoutes = () => {
  ...
  monitoring.get("/mentees", (c) =>
    new MonitoringController(c).getMenteesProgress(),
  );
  monitoring.get("/mentees/:studentId/logbooks", (c) =>
    new MonitoringController(c).getStudentLogbooks(),
  );
  ...
  monitoring.get("/logbook", (c) =>
    new MonitoringController(c).getMenteesProgress(),
  );
  monitoring.get("/logbook/:studentId", (c) =>
    new MonitoringController(c).getStudentLogbooks(),
  );
